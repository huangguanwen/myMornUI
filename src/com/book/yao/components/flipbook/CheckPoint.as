package com.book.yao.components.flipbook
{
	...
	{		
		...
		private function checkPageAngle(cPoint:Point, dPoint:Point):void
		{
		...
		private function pageFirstMoveCompleteHandler():void
		{
			...
			{
				case HotName.RIGHT_DOWN:
				    TweenLite.to(_targetPoint, PageConfig.page_speed, {x:0, y:_pageHeight, ease:Circ.easeOut,onUpdate:pageMovingHandler,onComplete:pageMoveCompleteHandler });
				    break;
				case HotName.RIGHT_UP:
				    TweenLite.to(_targetPoint,  PageConfig.page_speed, {x:0, y:0, ease:Circ.easeOut,onUpdate:pageMovingHandler,onComplete:pageMoveCompleteHandler });
				    break;
				case HotName.LEFT_DOWN:
				    TweenLite.to(_targetPoint,  PageConfig.page_speed, {x:_pageWidth, y:_pageHeight, ease:Circ.easeOut,onUpdate:pageMovingHandler,onComplete:pageMoveCompleteHandler });
				    break;
				case HotName.LEFT_UP:
				    TweenLite.to(_targetPoint,  PageConfig.page_speed, {x:_pageWidth, y:0, ease:Circ.easeOut,onUpdate:pageMovingHandler,onComplete:pageMoveCompleteHandler });
				    break;
			}
		...
		private function checkTargetPage():void
		{
			...
			{
				if (_targetPoint.x < _pageWidth / 2)
				{
